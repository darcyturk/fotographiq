  ...
  render() {
    return(
      <View style={styles.container}>
        ...
        <Toolbar backIcon border navigator={this.props.navigator} title='Política de privacidade' />
        <ScrollView>
