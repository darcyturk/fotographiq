...
class AccountTypeSelector extends Component {
  ...
  render() {
    ...
    if (this.props.error) {
      errorMessage = <Text style={formStyle.errorBlock}>Please select an option from above.</Text>;
    }
    ...
    return(
      <View style={styles.container}>
        ...
        <Text style={styles.question}>You want to use the application as:</Text>
