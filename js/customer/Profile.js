...
class Profile extends Component {
  ...
  _openBarbersChart() {
    this.props.navigator.push({
      ...
      title: 'Performance of the barbershops',
    ...
    if (this.props.isAdmin) {
      reviewBarbersContent = (
        <Touchable
          ...
          <Text style={styles.subtitle}>Review Barbershops</Text>
        </Touchable>
      )
      barbersChartContent = (
        <Touchable
          ...
          <Text style={styles.subtitle}>Performance of the Barbershops</Text>
        </Touchable>
      )
    };
