    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.innerContainer}>
          ...
          <Text style={styles.info}>Enter the code received by SMS:</Text>
          ...
          <View style={styles.linkContainer}>
            <Text style={formStyle.helpBlock.normal}>Did not receive the code?</Text>
            <TouchableOpacity onPress={this._resendCode.bind(this)}>
              <Text style={[formStyle.helpBlock.normal, styles.link]}>{linkText}</Text>
            </TouchableOpacity>
            <Text style={formStyle.helpBlock.normal}>or</Text>
            <TouchableOpacity onPress={this._editNumber.bind(this)}>
              <Text style={[formStyle.helpBlock.normal, styles.link]}>Change mobile number</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
