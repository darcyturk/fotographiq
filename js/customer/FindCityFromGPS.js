...
class FindCityFromGPS extends Component {
  ...
  render() {
    ...
    if (isLoading) {
      content = (
        <View>
          <Text style={styles.info}>Searching for location via GPS</Text>
          <ActivityIndicator />
        </View>
      );
    } else if (error) {
      content = (
        <View style={styles.errorContainer}>
          <Text style={styles.info}>We could not retrieve your location.</Text>
          <Text style={styles.info}>Please enter your city.</Text>
          <SearchCity />
        </View>
      );
    } else if (this.props.city) {
      content = <Text style={styles.info}>Found city: {this.props.city.name} - {this.props.city.state.initials}</Text>
    }
